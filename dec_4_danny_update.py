        ...
        dbc.Col([
            dcc.Dropdown(
                ...
                dbc.Tabs([
                    ...
                    label = "Compare countries over time"),
                    dbc.Tab([
                    ...
                    ], label = "Compare countries across multiple variables", style={"position":"relative"})
                ])
...
def update_select_country(selected_metric, selected_country):
    ...
    fig_selected_country.update_layout(
        ...
        title=f"Development in {selected_metric}: {df.loc[df['country_text_id'] == country_iso, 'country_name'].iloc[0]}"
    ),
